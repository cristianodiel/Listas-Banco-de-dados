...
select livro.titulo, editora.nome from livro, editora
where editora.telefone = '12345'; -- não ha nenhuma editora com esse telefone
select livro.titulo, editora.nome from livro, editora
where editora.telefone = '123345';-- mas com 123345 há
...
where livro.titulo like '%123' and editora.nome ='Abril' and autor.nome like '%Tolkien'; 
